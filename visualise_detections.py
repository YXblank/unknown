...
def compute_prob(x, distribution):
    ...
    pdf = distribution.log_prob(dx+5).exp()
...
im = cv2.imread("/home/xuyuan/pan/OWOD-master/datasets/VOC2007/JPEGImages/" + file_name + ".jpg")
...
model = '/home/xuyuan/pan/OWOD-master/output/t1_final/unknow/model_final.pth'
cfg_file = '/home/xuyuan/pan/OWOD-master/configs/OWOD/t1/t1_test.yaml'
...
param_save_location = os.path.join('/home/xuyuan/pan/OWOD-master/output/t1_clustering_with_save/energy_dist_' + str(20) + '.pkl')
