...
im = cv2.imread("/home/xuyuan/pan/unknow/JPEGImages/" + file_name + ".jpg")

model = '/home/xuyuan/pan/unknow/model_final.pth'
cfg_file = '/home/xuyuan/pan/unknow/t1/t1_test.yaml'
...
param_save_location = os.path.join('/home/xuyuan/pan/unknow/t1/' + str(20) + '.pkl')
